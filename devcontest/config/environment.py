...
import devcontest.lib.app_globals as app_globals
import devcontest.lib.helpers
...
def load_environment(global_conf, app_conf):
	...
	config.init_app(global_conf, app_conf, package='devcontest', paths=paths)

	config['routes.map'] = make_map()
	config['pylons.app_globals'] = app_globals.Globals()
	config['pylons.h'] = devcontest.lib.helpers
